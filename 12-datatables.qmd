...
::: {.callout-note title="Invoercel en formules"}
...
`r hide("Antwoord")` ![Gegevenstabel maandbetalingen voor verschillende aflossingstermijnen](images/datatables/tabl001_result1.png)

![Gegevenstabel maandbetalingen voor verschillende aflossingstermijnen en rentepercentages](images/datatables/tabl001_result2.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![Gegevenstabel verkoopprognose](images/datatables/tabl002_result.png) `r unhide()`
:::
::::
