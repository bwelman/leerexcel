...
::: {.callout-note title="Selectie gegevensgebied"}
...
::: {.callout-tip title="Snelle Analyse"}
...
2.  Klik op de [Snelle Analyse]{.uicontrol} knop [![](images/common/button-quick-analysis.png)]{.uicontrol} in de rechteronderhoek van het geselecteerde gebied.
...
::: {.callout-note title="Geselecteerse grafiekelementen"}
...
::: {.callout-tip title="Uitlijnen op raster"}
...
::: {.callout-tip title="Opties grafiektitel"}
...
::: {.callout-tip title="Opties grafiekelementen"}
...
[Bestand]{.smallcaps}: `Aandelen.xlsx`
...
-   Afmeting grafiek: 10 cm breed en 10 cm hoog. `r unhide()`
:::
...
::: {.content-visible when-format="html:js"}
`r hide("Hint")` Maak eerst in een werkblad twee kolommen met waarden voor X en berekende waarden voor Y. Maak dan een spreidingsdiagram en pas vervolgens de opmaak aan. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/charts/graf005_chart.png) `r unhide()`
:::
::::
