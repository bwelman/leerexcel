...
::: {.callout-note title="Doelzoeken of Oplosser?"}
...
::: {.callout-important title="Controleer beschikbaarheid Oplosser"}
...
::: {.callout-note title="Meerdere doelstellingen en indirecte variabelen"}
...
::: {.callout-tip title="Meerdere randvoorwaarden toevoegen"}
...
::: {.callout-note title="Interpretatie antwoordrapport"}
...
#### Wijziging beginwaarden veranderende cellen {.unnumbered}
...
#### Wijziging instellingen Oplosser {.unnumbered}
...
::: {#tbl-solver-options tbl-colwidths="[25,75]"}
...
: Uitleg van de opties bij Oplosser.
:::
...
`r hide("Antwoord")` 1. Twee beslissingsvariabelen: - Aantal kersenbonbons per doos (= K) - Aantal hazelnootbonbons per doos (= H) 2. Doelfunctie is de maximale winst op een doos (= W): `W = 0,28*K + 0,20*H` 3. Restricties: - Aantal kersenbonbons per doos: `K >= 10` - Totaal aantal bonbons per doos: `K + H >= 35` - Gewicht doos: `2*K + 1*H >= 40` - Gewicht doos: `2*K +1*H <= 60` - Oppervlakte bonbons: `16*K + 8*H >= 320` - Aantal bonbons is een geheel getal: `K = integer , H = integer` - Aantal bonbons is een positief getal: `K >= 0 , H >= 0`

Optimale inhoud doos: aantal kersenbonbons = 10, aantal hazelnootbonbons = 40. De winst per doos is dan € 10,80 en aan alle restricties wordt voldaan. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` 1. Vier beslissingsvariabelen: Aantal winkels type A (= A), type B (= B), type C (= C)en type D (= D). 2. Doelfunctie is de totale omzet (= O): `O = 24*A + 20*B + 11*C + 5*D` 3. Restricties: - Maximale investering: `4*A + 3*B + 2*C + 1*D <= 14` - Elk aantal winkels is een geheel getal: `A = integer , B = integer , C = integer , D = integer` - Elk aantal winkels is een positief getal: `A >= 0 , B >= 0 , C >= 0 , D >= 0`

Optimale aantal winkels type A = 0, aantal type B = 4, aantal type C = 1, aantal type D = 0. De totale omzet = 91 miljoen EUR. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` 1. Drie beslissingsvariabelen: Aantal model Runner per week (= R), aantal model Lady T per week (= T)en aantal model Super A per week (= A). 2. Doelfunctie is de maximale winst per week (= W): `W = 6*R + 5*T + 4*A` 3. Restricties: - Aantal model Runner per week: `R <= 300` - Aantal model Lady T per week: `T <= 400` - Aantal model Super A per week: `A <= 400` - Maximale productietijd per week: `0,31*R 0,20*T + 0,25*A <= 150` - Maximale investering per week: `16*R + 12*T +10*A <= 8000` - Aantal van elk model is een geheel getal: `R = integer , T = integer , A = integer` - Aantal van elk model is een positief getal: `R >= 0 , T >= 0 en A >= 0`
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Aantal type 1 = 0, aantal type 2 = 4, aantal type 3 = 10, winst = € 1080. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Aantal zakken gewoon = 14, aantal zakken speciaal = 4, maaltijdkosten = € 168. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Per dag: type 1 = 7,500 kg, type 2 = 1,397 kg, type 3 = 1,426 kg , kosten = € 68,37. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Per dag: aantal per merk Y = 4, aantal merk Z = 2, kosten = € 0,56. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/solver/solv008_result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/solver/solv009_result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` \|Type lening\|Bedrag\| \|-----------\|------\| \|Persoonlijke lening\|450 K€\| \|Eerste hypotheek\|1125 K€\| \|Tweede hypotheek\|1125 K€\| \|Autolease\|300 K€\|

Totale opbrengst 422 K€. Bij weergave op eurocent nauwkeurig kunnen er afrondingsverschillen zijn. `r unhide()`
:::
::::
