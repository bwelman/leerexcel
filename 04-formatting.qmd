...
## Getalopmaak {#sec-formatting-numberformat-task}
...
`r hide("Hint")` + Kolom A, getallen opgemaakt als tekst. + Kolom B, financiële notatie. + Kolom C, getallen eerst opgemaakt met duizendtal notatie daarna aantal decimalen verminderen tot 0. + Kolom D, getallen ingevoerd met procentsymbool daarna aantal decimalen aangepast. + Kolom E, datums ingevoerd daarna korte datumnotatie voor de eerste twee en lange datumnotatie voor de laatste twee. `r unhide()`
