...
::: {.callout-tip title="Meerdere kolommen tegelijk aanpassen"}
...
::: {.callout-tip title="Meerdere rijen tegelijk aanpassen"}
...
::: {.callout-note title="Tekstterugloop niet zichtbaar"}
...
::: {.callout-note title="Datums en tijden worden als getallen opgeslagen"}
...
::: {.callout-tip title="Pas de opmaak toe op meerdere cellen"}
...
2.  Selecteer alle cellen met de behaalde omzet, dus cel C2 t/m cel C15.
