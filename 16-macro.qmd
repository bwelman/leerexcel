...
::: {.callout-note title="Macro's en VBA"}
...
::: {.callout-important title="Controleer aanwezigheid Tab Ontwikkelaars"}
...
::: {#tbl-macro-security-settings tbl-colwidths="[25,75]"}
...
::: {.callout-tip title="Macro's ontwerpen"}
...
::: {.callout-note title="Eigenschappen macro"}
Al deze keuzes (naam, snelkoppeling, opslaglocatie, beschrijving) kunnen later worden gewijzigd.
:::
...
::: {.callout-warning title="Bestandsextensie voor macro's"}
...
::: {.callout-important title="Relatieve verwijzingen"}
De modus "Relatieve verwijzingen gebruiken" is een schakelaar. Deze blijft actief (of inactief) totdat je opnieuw op de knop klikt om de status te wijzigen. Controleer altijd de status voordat je gaat opnemen als het referentietype belangrijk is.
:::
...
Neem een macro op die er voor zorgt dat bij het afdrukken ook de rasterlijnen worden afgedrukt. Deze eigenschap is te vinden bij [tab Pagina-indeling \> Pagina-instelling \> tab Blad]{.uicontrol}.
