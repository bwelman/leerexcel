...
::: {.callout-tip title="Data Analyse met Excel"}
...
`r hide("Hint")` Je kunt op de volgende manieren een trendlijn toevoegen.

-   Selecteer de punten in de grafiek, dan rechter muisklik en kies [Trendlijn toevoegen]{.uicontrol}.
-   Selecteer het grafiekgebied en klik op de knop ![](images/common/button-chart-elements.png) naast de grafiek en kies [Trendlijn \> Lineair]{.uicontrol}. `r unhide()`
:::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Gewicht = 1,65\*Lengte - 153,3 `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Cijfer = 0,2038\*Studietijd + 3,3637 `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Krimpperc = 0,0796\*Temp - 3,546

Bij een temperatuur van 65^o^C is het voorspelde krimppercentage 1,6%. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Weerstand = 0,0786\*Temp + 21,214

Bij een temperatuur van 400^o^C is de voorspelde weerstand 52,6 Ohm. `r unhide()`
:::
::::
