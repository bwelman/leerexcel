...
## Wat is Excel? {#sec-intro-over}

Excel maakt deel uit van het Microsoft Office-pakket. Hiermee kun je berekeningen uitvoeren in spreadsheets. Dit hoofdstuk biedt een inleiding tot spreadsheets in het algemeen, met specifieke aandacht voor Excel.
...
::: {.callout-note title="Startschem uitschakelen"}
...
::: {.callout-note title="Opslaan na wijzigingen"}
...
::: {.callout-tip title="Verbergen/Weergeven lint"}
