...
::: {.callout-tip title="Navigeren in het formulier"}
...
::: {.callout-warning title="Samenvoeging is statisch"}
...
::: {.callout-note title="Tabelkoppen"}
...
::: {.callout-important title="Sortering ongedaan maken"}
...
::: {.callout-note title="Meervoudige selectie"}
...
::: {.callout-note title="Gestructureerde verwijzingen"}
...
`r hide("Antwoord")` ![](images/tables/list001_solution.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/tables/list004_solution.png) `r unhide()`
:::
::::
