...
::: {.callout-note title="Zichtbaarheid taakvenster"}
...
::: {.callout-tip title="Velden verwijderen"}
...
::: {.callout-note title="Waardeveldinstellingen"}
...
`r hide("Hint")` Gebruik [product]{.varname} als rijvariabele. Een kolomvariabele is er in dit geval niet. Sorteer in het draaitabelrapport de omzet van hoog naar laag.

![](images/pivots/supermarket-products.png) `r unhide()`
:::
::::
...
::: {.callout-note title="Gegevensgebied en locatie draaitabel"}
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Alleen omzet in de maand juni. Niets in april en mei. `r unhide()`
:::
...
::: {.callout-note title="Automatische tijdgroepering"}
...
::: {.callout-note title="Onderdelen van een tijdlijn"}
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo003_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo004_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo005_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo006_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo007_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo008_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Hint")` Maak een extra kolom waarin bepaald wordt of de afstand tot het centrum meer dan 15 km is. `r unhide()`
:::

::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` 28,5 min. `r unhide()`
:::
:::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo010_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/pivots/pivo011_report.png) `r unhide()`
:::
::::
