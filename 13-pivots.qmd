...
|Gebied  |Toelichting                                                                                                    |
|--------|---------------------------------------------------------------------------------------------------------------|
|Waarden |De velden met numerieke gegevens die je wilt samenvatten, mestal voor de berekening van totalen en gemiddeldes.|
...
verkoper <- c("Anderson","Brown", "Gonzalez", "Hernandez", "Johnson", "King", "Lewis", "Miller", "Phillips", "Smith", "Williams")
names(verkoper)[9] = "answer"
maand <- c("jan", "feb", "mrt", "apr", "mei", "jun", "jul", "aug", "sep", "okt", "nov", "dec")
names(maand)[1] = "answer"
```


1. Welke verkoper heeft het meeste verkocht in december 2010?  
   Verkoper `r mcq(verkoper)`

2. In welke maand van welk jaar was de verkoop van software het grootst?  
   Jaar `r mcq(c(2010, answer=2011))`, Maand `r mcq(maand)`
