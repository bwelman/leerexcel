...
::: {.callout-tip title="Oplosser gebruiken"}
...
`r hide("Toelichting")` - [Cel instellen]{.uicontrol}: De cel met het maandresultaat, B18. - [Op waarde]{.uicontrol}: Voor een break-even is dat 0. - [Door wijzigen van cel]{.uicontrol}: Dit is de cel met het aantal koppen koffie dat verkocht moet worden, B16. `r unhide()`
:::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Omzet € 64102,56 `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Oplossing 1: Q = 0,2120 en TK = TO = 16,74

Oplossing 2: Q=11,7879 en TK = TO = 248,26 `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Storting € 1915,29. `r unhide()`
:::
::::
