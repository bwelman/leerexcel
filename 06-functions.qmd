...
::: {.callout-important title="Lijstscheidingsteken"}
...
::: {.callout-tip title="Hulp voor de functie"}
...
4.  Bevestig de keuze op een van de volgende manieren:
    ...
    -   Klik op de knop ![](images/functions/enter-function.png) [Invoeren]{.uicontrol} aan het begin van de formulebalk.
...
::: {.callout-tip title="Selecteren celbereik"}
...
`r hide("Resultaat")` ![](images/functions/example-statistical-result.png) `r unhide()`
:::
:::::
...
::: {.content-visible when-format="html:js"}
`r hide("Hint")` Je moet de begintijd aftrekken van de eindtijd. `r unhide()`

`r hide("Resultaat")`

![](images/functions/example-datetime-result.png) `r unhide()`
:::
::::

## Logische functie ALS {#sec-function-logical}

De functies in de categorie [Logisch]{.uicontrol} doen wat met de uitkomsten `WAAR` of `ONWAAR`. De meest bekende en ook meest gebruikte functie in deze categorie is de functie `ALS`. Simpel gezegd komt de werking van deze functie neer op:
...
::: {.callout-note title="Meerdere voorwaarden"}
...
::: {.callout-note title="Aantal tekens"}
...
::: {.callout-tip title="Geneste functies"}
...
::: {.callout-tip title="Bereik hele kolom"}
...
::: {.content-visible when-format="html:js"}
`r hide("Resultaat")` ![](images/functions/example-countif-result.png) `r unhide()`
:::
:::::
...
::: {.callout-note title="Draaitabellen"}
...
::: {.callout-note title="Termijn en rente per periode"}
...
::: {.callout-note title="Negatief getal"}
...
::: {.callout-important title="Betalingen"}
...
::: {.callout-tip title="Exacte overeenkomst of benadering"}
...
::: {.content-visible when-format="html:js"}
`r hide("Hint")` 1. Te gebruiken functies bij deze opgave: `Datum`, `Jaar`, `Maand`, `Dag`, `Vandaag`.
...
3.  Een datum is in Excel in werkelijkheid gewoon een getal, waarmee dus gerekend kan worden. Om het tijdsverschil tussen twee data te bepalen kun je dus twee data van elkaar aftrekken. `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Hint")` 1. In de laatste vier kolommen hangt het antwoord van één of meerdere voorwaarden af, wat dus inhoudt dat er steeds een `ALS` functie gebruikt moet worden.
...
5.  Wanneer er nog geen datum bekend is, dan is het betreffende veld leeg. Hierop kun je ook controleren. `r unhide()`
:::
::::
