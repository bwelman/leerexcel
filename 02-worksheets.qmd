...
::: {.callout-tip title="Nieuwe selectie na Enter"}
Je kunt deze richting wijzigen in [Bestand \> Opties \> Geavanceerd]{.uicontrol}: beneden, boven, links en rechts.
:::
...
::: {#prp-ws-rename}
1.  Wijzig de naam van een werkblad op een van de volgende manieren:

    - Rechtermuisklik op de tabnaam en kies dan [Naam wijzigen]{.uicontrol}.
    - Dubbelklikken op de tabnaam van het werkblad.
...
: Meest gebruikte selecties met de muis.
:::
...
::: {.callout-tip title="Tips bij het selecteren met de muis"}
...
::: {.callout-important title="Inhoud en opmaak niet tegelijk invoeren"}
...
::: {.callout-tip title="Toegang tot pagina-instellingen"}
