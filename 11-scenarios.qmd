...
::: {.callout-tip title="Bewaar de huidige situatie altijd in een scenario"}
...
::: {.callout-tip title="Gebruik van namen in een scenario"}
...
::: {.callout-warning title="Waarschuwing bij gebruik van formules"}
...
`r hide("Antwoord")` ![](images/scenarios/scen003_report.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/scenarios/scen004_report.png) `r unhide()`
:::
::::
